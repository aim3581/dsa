...
o/p: {{13, 9, 5, 1},
     {14, 10, 6, 2},
     {15, 11, 7, 3},
     {16, 12, 8, 4}} 3. Given an array containing positive and negative numbers, find all the sub arrays in it, whose sum is equal to zero.
...
o/p: 2, 2, 2, 2, 5, 5, 5, 1, 1, 4, 3, 9 4. Write code for Deadlock in Multi Threading.
